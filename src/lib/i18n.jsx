...
const translations = {
  pt: {
    ...
    booking: {
      ...
      weatherNotice: 'A hora exata da aula é combinada convosco consoante as condições do mar e meteorológicas.',
  ...
  en: {
    ...
    booking: {
      ...
      weatherNotice: 'The exact lesson time is arranged with you depending on sea and weather conditions.',
      guestName: 'Full name',
      guestEmail: 'Email',
      guestPhone: 'Phone',
